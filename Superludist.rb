class Superludist < Formula
    ...
    def install
      ...
      cmake_args << "-DTPL_PARMETIS_LIBRARIES=#{Formula["chipiron/myformulae/Parmetis"].opt_lib}/libparmetis.#{dylib_ext};#{Formula["metis"].opt_lib}/libmetis.#{dylib_ext}"
      cmake_args << "-DTPL_PARMETIS_INCLUDE_DIRS=#{Formula["chipiron/myformulae/Parmetis"].opt_include};#{Formula["metis"].opt_include}"
